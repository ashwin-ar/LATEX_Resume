...
\vspace{2pt}
  ...
  %\textbf{Leistungselektronik:} {Frequenzumrichter, MPPT, AC/DC-Wandler, PV-Anlagen, Batteriemanagements} \\ \vspace{2pt}  %\textbf{Laboratory Tools:} { Multimeters, High frequency DSO, Frequency generator, PV simulators}
  ...
  %\textbf{Architektur \& KI:} {Microsoft 365 (Excel-Experte), KI-gestützte Entwicklung (LLM-APIs, Gemini, OpenAI)} 
...
\begin{itemize}[leftmargin=*]
    \item Leitung der Firmware Entwicklung für \textbf{3–20 PS Frequenzumrichter} in C, Verwaltung des gesamten Lebenszyklus auf TI und RL78 Mikrocontrollern.
    \item \textbf{Entwicklung} einer modularen Anwendungsschicht, bei der die Steuerungslogik mithilfe von \textbf{HAL} von der Hardware entkoppelt und die Portabilität optimiert wurde. 
    \item Entwicklung eines hocheffizienten (98 \%) \textbf{P\&O-MPPT}-Algorithmus für Gleichstrom-Solarpumpensysteme.   
    ...
    %\item \textbf{Modellierte} Antriebsregelkreise in \textbf{Simulink} zur Überprüfung der PID-Stabilität.  
  \end{itemize}
\vspace{8pt}
\noindent
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Temperatursenkung um 7°C} bei Lasttrennschaltern gem. IEC 60947-3 durch thermische Optimierung.    % \item \textbf{Reduzierung der Durchlassenergie ($I^2t$) um 4 \%} durch Optimierung des Kontaktstellendesigns.
...
\begin{itemize}[leftmargin=*]
\item \textbf{Einwerbung von Fördermitteln} in Höhe von \EUR 9.900 durch das Indische Ministerium für Wissenschaft \& Technologie.
\item Leitung der gesamten POC-Entwicklung, einschließlich Hardwareauswahl, Steuerung von Wechselstrom und Gleichstrommotoren, Sensorintegration sowie Firmware und IoT-Entwicklung.
\end{itemize}
